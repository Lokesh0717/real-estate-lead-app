...
const RealEstateSidebar = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      if (result.success) {
        navigate('/realestate-login', { replace: true });
      }
    } catch (error) {
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-gray-900 text-white flex flex-col shadow-xl z-40">
      ...
      <section className="p-6 border-b border-gray-800">
        <section className="flex items-center space-x-2">
          <section className="w-10 h-10 bg-gradient-to-br from-amber-600 to-amber-800 rounded-lg flex items-center justify-center shadow-lg">
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
          </section>
          <section>
            <h1 className="text-xl font-bold tracking-tight">EliteProperties</h1>
      ...
      <section className="p-4 border-t border-gray-800">
        <section className="mb-4 p-3 bg-gray-800 rounded-lg">
          <p className="text-xs text-gray-400 mb-1 tracking-wide">Logged in as</p>
